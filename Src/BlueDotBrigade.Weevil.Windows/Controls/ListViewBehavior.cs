namespace BlueDotBrigade.Weevil.Windows.Controls
{
	...
	/// </summary>
	/// <seealso href="https://michlg.wordpress.com/2010/01/16/listbox-automatically-scroll-currentitem-into-view/"/>
	public class ListViewBehavior : DependencyObject
	{
		#region Properties

		public static readonly DependencyProperty AutoScrollToCurrentItemProperty = DependencyProperty.RegisterAttached("AutoScrollToCurrentItem", typeof(bool), typeof(ListViewBehavior), new UIPropertyMetadata(default(bool), OnAutoScrollToCurrentItemChanged));
