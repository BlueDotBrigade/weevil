...
4. Before WiX compiles, the installer checks `WEEVIL_PLUGINS_PATH` for an optional `TelemetryCredentials.wxs` file and copies it; otherwise it stages the committed `TelemetryCredentials.wxs_` template.
