...
- [Data Analysis](#data-analysis)
  - [Detecting Data](#detecting-data)
    ...
    - [`Detect Rising Edges`](#detect-rising-edges)
    - [`Detect Falling Edges`](#detect-falling-edges)
    - [`Stable Value Runs`](#stable-value-runs)
    - [`Matching Record Runs`](#matching-record-runs)
